defmodule AnubisWeb.ContactLiveTest do
  use AnubisWeb.ConnCase

  import Phoenix.LiveViewTest
  import Anubis.ContactsFixtures

  @create_attrs %{first_name: "some first_name", last_name: "some last_name", email: "some email", tags: ["option1", "option2"]}
  @update_attrs %{first_name: "some updated first_name", last_name: "some updated last_name", email: "some updated email", tags: ["option1"]}
  @invalid_attrs %{first_name: nil, last_name: nil, email: nil, tags: []}
